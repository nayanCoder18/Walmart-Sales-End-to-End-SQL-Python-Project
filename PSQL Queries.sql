...
---question 8
-- Identify 5 branch with highest decrice ratio in revenue compare to last year(current year 2023 and last year 2022)
...
select 
	...
	round((ls.revenue - cr.revenue)::numeric/ls.revenue::numeric *100 ::numeric,2) as revenue_desc_retio
from revenue_2022 as ls
join 
revenue_2023 as cr
on ls.branch = cr.branch
where 
	ls.revenue > cr.revenue
order by  4 desc
limit 5
